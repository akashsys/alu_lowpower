...
echo ">>> STATUS: Executing absolute path sync-back to host..."

# Define your absolute paths
AGENT_BASE="/home/ubuntu/example-verilog-codebase/sources"
WINDOWS_HOST_DEST="C:/Users/AKASH NAGARIA/Desktop/alu_lowpower/sources"

cp "$AGENT_SRC/elastic_credit_arbiter.v" "$WINDOWS_MOUNT/elastic_credit_arbiter.v"
cp "$AGENT_SRC/netlist.v" "$WINDOWS_MOUNT/netlist.v" 2>/dev/null