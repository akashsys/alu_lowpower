...
*Goal: Perform Static Timing Analysis (STA), identify violations, and suggest Engineering Change Order (ECO) patches to meet timing constraints while maintains the area of module requirements.
